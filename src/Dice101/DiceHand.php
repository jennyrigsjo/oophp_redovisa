 ...
 */
class DiceHand implements DiceHandHistogramInterface
{

    use DiceHandHistogramTrait;
    ...
    public function roll()
    {
        ...
        array_push($this->series, $this->values);
    }

    /**
     * Get the dice of the dice hand.
     *
     * @return array with the dice (die objects).
     */
